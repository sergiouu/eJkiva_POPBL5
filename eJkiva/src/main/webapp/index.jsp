							...
							<div class="row">
								<div class="col-lg-12"><!--  
									<form id="register-form" action="login.html" method="post"
												...
												<div class="form-group">
													<input type="date" name="borndat" id="borndat" tabindex="2"
														class="form-control" placeholder="Born Date">
												</div>
												<div class="form-group">
												...
												<div class="form-group text-center">
													<c:if test="${not empty requestScope.errorR}">
														<div class="alert alert-danger" role="alert">
															<strong>Hey!</strong> ${requestScope.errorR}
														</div>
													</c:if>
									...
									<form id="login-form" action="login.html" method="post" 
												...
												<div class="form-group text-center">
													<c:if test="${not empty requestScope.errorL}">
														<div class="alert alert-danger" role="alert">
															<strong>Hey!</strong> ${requestScope.errorL}
														</div>
													</c:if>
