...
public class CarriesId implements java.io.Serializable {
	...
	public CarriesId(short orderProductId) {
		this.orderProductId = orderProductId;
	}

	public CarriesId(short orderProductId, Byte initialWorkstationId, Byte destinyWorkstationId, Byte machineId,
			Boolean state) {
		this.orderProductId = orderProductId;
