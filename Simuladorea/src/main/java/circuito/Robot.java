...
public class Robot extends Thread {
	...
	//	System.out.println("DESALOJAR robot" + wsSiguiente.getInside() + wsSiguiente.getInside().getWsDestino() );
	}
	...
	private void cargarSiDebe() {
		if(wsActual.equals(wsCogerProducto)) {
			...
			//coge el producto
			System.out.println("Robot " + this + " ha cogido: " + this.producto.getDescription()+" con id: "+this.producto);
		}
	}
	...
	private void moverAWsSiguiente() {
		...
		wsSiguiente = null;
		System.out.println("se ha movido:" + "robot " + this + " a " +wsActual);
	...
	void isEnDestino() {
		if(wsCogerProducto==null) {
		if(wsActual.equals(this.wsDestino)) {
		//	System.out.println("IS EN DESTINO");
			dejarProductoEnWs();
			apagarRobot();
		}
	...
	void dejarProductoEnWs() {
		...
		//		System.out.println("holaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa");
			...
			//    	System.out.println("SARTUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUU: "+pedido.getCantidad());
		    		...
		    		System.out.println("Robot " +this + " deja: " + this.producto.getDescription());
	...
	void cogerProductoDeWs() {
		for(Producto p : this.getWsActual().getListaProductos()) {
			if(p.getId() == this.producto.getId()) {
				this.producto.setDescripcion(p.getDescription());
			}
		}
	}
